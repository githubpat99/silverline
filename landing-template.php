...
<div class="landing-container">
    <div class="landing-content">
        ...
        <video controls width="100%" style="margin-top: 30px; border-radius: 12px;">
            <source src="<?php echo get_template_directory_uri(); ?>/videos/Info-Silverline.mp4" type="video/mp4">
