<?php
/*
Template Name: My Next Balance Template
*/
...
<div class="site-content">
    ...
    <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
        <input type="hidden" name="action" value="calculate_kpis">
            ...
            <table class="form-table th-activa">
                ...
                <tbody>
                    <tr class="form-group">
                        ...
                        <td><input type="number" id="bank" name="bank" value="5000" min="0" required></td>
                    </tr>
                    <tr class="form-group">
                        ...
                        <td><input type="number" id="depot" name="depot" value="15000" min="0" required></td>
                    </tr>
                    <tr class="form-group">
                        ...
                        <td><input type="number" id="agh" name="agh" value="600000" min="0" required></td>
                    </tr>
                    <tr class="form-group">
                        ...
                        <td><input type="number" id="s3a" name="s3a" value="75000" min="0" required></td>
                    </tr>
                    <tr class="form-group">
                        ...
                        <td><input type="number" id="efh" name="efh" value="1600000" min="0" required></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="form-table th-passiva">
                ...
                <tbody>
                    <tr class="form-group">
                        ...
                        <td><input type="number" id="loan" name="loan" value="500" min="0" required></td>
                    </tr>
                    <tr class="form-group">
                        ...
                        <td><input type="number" id="credit" name="credit" value="2000" min="0" required></td>
                    </tr>
                    <tr class="form-group">
                        ...
                        <td><input type="number" id="mortgage" name="mortgage" value="900000" min="0" required></td>
                    </tr>
                    <tr class="form-group">
                        ...
                        <td><input type="number" id="otherDebt" name="otherDebt" value="3000" min="0" required></td>
                    </tr>
                </tbody>
            </table>
        </div>
        <button type="submit" id="submitForm">Finanzanalyse</button>
    </form>
