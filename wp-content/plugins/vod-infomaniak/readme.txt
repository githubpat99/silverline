...
You can report security bugs through the Patchstack Vulnerability Disclosure Program. The Patchstack team help validate, triage and handle any security vulnerabilities. [Report a security vulnerability.](https://patchstack.com/database/vdp/vod-infomaniak)
...
Sur notre site internet, nous possédons une Foire au Question (https://www.infomaniak.com/fr/support/faq/) qui répond à un grand nombre de questions et propose des guides/tutoriaux vidéos.
...
= 1.5.9 (10/09/2024) =
* micro fix, adds the ability to display videos in responsive mode

= 1.5.8 (29/08/2024) =
* safety element added to connection

= 1.5.7 (29/04/2023) =
* various corrections, and compatibility testing of the latest version of wordpress

= 1.5.6 (12/06/2023) =
* fix link to configuration in EN_US version, fix video preview if media protected, fix possible duplicate file in media listing

= 1.5.5 (31/05/2023) =
* fix error when plugin activated in WP but not connected to any vod account

= 1.5.4 (15/05/2023) =
* added progress when importing videos, fixed callback, random disconnection and others
...
= 1.5.0 (30/01/2023) =
* Mise en place version hybride pour préparer migration vod v1 vers v2
