<footer>
    <div class="progress-container">
        ...
        <div class="steps">
            <?php 
            $total_steps = 4; // Define the number of steps
            ...
            for ($i = 1; $i <= $total_steps; $i++) : 
                ...
                if ($i == 1) {
                    $step_url = 'https://silverline.it-pin.ch/';
                } elseif ($i == 2) {
                    $step_url = 'https://silverline.it-pin.ch/step2/';
                } elseif ($i == 3) {
                    $step_url = 'https://silverline.it-pin.ch/step3/';
                } elseif ($i == 4) {
                    $step_url = 'https://silverline.it-pin.ch/step4/';
                } else {
